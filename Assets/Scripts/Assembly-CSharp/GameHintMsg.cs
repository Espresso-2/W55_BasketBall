...
public class GameHintMsg : MonoBehaviour
{
	...
	public GameHintMsg()
	{
		hints = new string[26]
		{
			"YOU WILL MOVE SLOW", "YOUR ENERGY WILL NOT", "STEAL THE BALL WHEN IT IS BLINKING", "Upgrade your DEFENSE", "YOU CAN’T STEAL WHEN PLAYER IS SHOOTING", "WIN TOURNAMENTS 3 TIMES TO COLLECT TROPHIES", "SCORE 3S BY SHOOTING", "RECHARGE YOUR ENERGY BY", "PUMP FAKE BY QUICKLY", "YOU CAN STEAL THE",
			"TIRED DEFENDERS ARE EASIER TO GET PAST", "TIP: RELEASE AFTER PEAK OF JUMP", "GET A RUNNING START TO DUNK", "PLAY EVERYDAY TO OPEN YOUR DAILY BAGS", "YOU NEED FULL ENERGY TO STEEL", "GET A FREE BAG BY WINNING A TOURNAMENT 3X", "Meet people at the rim to block their dunks", "OPPONENT MUST BE IN RED TO STEEL", "CONSERVE YOUR ENERGY WHEN POSSIBLE", "JUMPING USES A LOT OF ENERGY",
			"YOU NEED FULL ENERGY TO DUNK", "GETTING PAST THE DEFENDER USES A LOT OF ENERGY", "JABSTEP by quickly tapping forward", "REPLAY TOURNAMENTS FOR AN INCREASING CHALLENGE", "PRESS BACK THEN FORWARD TO DO A CROSSOVER", "Use PUMPFAKES and JABSTEPS to confuse people"
		};
	}
