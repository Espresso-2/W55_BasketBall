...
public class OpenBag : MonoBehaviour
{
    ...
    public virtual void ShowOpenBagBox(bool isPremium, bool isDaily, string buyOneMoreBagHeadingTerm, string buyOneMoreBagTerm,
        int buyOneMoreOrigPrice, int buyOneMoreDiscountPrice)
    {
        Debug.Log("ShowOpenBagBox".FH7_RoyalBlue());
