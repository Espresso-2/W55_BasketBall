...
public class CoachRewardBox : MonoBehaviour
{
	...
	public virtual void Start()
	{
		...
		if ((@int >= num || (sessionVars.numMapViewsThisSession == 1 && UnityEngine.Random.Range(0, 100) >= 25)) && !sessionVars.goToPractice && PlayerPrefs.GetInt("IAP_ADS_REMOVED") == 0 && Stats.GetNumWins() >= 1 && AdMediation.IsVidAvail() && !TournamentView.showLeaderboardPanel)
		{
			SetUp();
			return;
		}
