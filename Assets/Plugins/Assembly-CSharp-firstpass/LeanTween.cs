		...
		for (int i = 0; i <= tweenMaxSearch && i < maxTweens; i++)
		{
			...
			if (tween.delay <= 0f)
			{
				...
				if (tweenAction >= TweenAction.MOVE_X && tweenAction < TweenAction.MOVE)
				{
					...
					{
						Color color3 = tween.uiImage.color;
						color3.a = val;
						tween.uiImage.color = color3;
					}
					...
					{
						CanvasGroup component3 = tween.trans.GetComponent<CanvasGroup>();
						component3.alpha = val;
					}
					...
					else if (tweenAction == TweenAction.TEXT_COLOR)
					{
						...
						if (trans.childCount > 0)
						{
							...
							{
								Text component4 = tran3.gameObject.GetComponent<Text>();
								if (component4 != null)
								{
									component4.color = obj3;
								}
							}
						}
					}
