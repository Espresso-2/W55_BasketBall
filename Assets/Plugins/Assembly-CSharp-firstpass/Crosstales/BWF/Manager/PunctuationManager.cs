...
namespace Crosstales.BWF.Manager
{
	...
	public class PunctuationManager : BaseManager
	{
		...
		public static int CharacterNumber
		{
			...
			set
			{
				...
				if (filter != null)
				{
					...
					instance.PunctuationCharsNumber = num;
				}
		...
		public void OnEnable()
		{
			...
			else if (!BaseHelper.isEditorMode && DontDestroy && instance != this)
			{
				if (!loggedOnlyOneInstance)
				{
					...
					Debug.LogWarning("Only one active instance of 'PunctuationManager' allowed in all scenes!" + Environment.NewLine + "This object will now be destroyed.");
				}
		...
		public static void Load()
		{
			if (instance != null)
			{
				filter = new PunctuationFilter(instance.PunctuationCharsNumber);
			}
		}
