...
namespace Crosstales.BWF.Manager
{
    ...
    {
        [Header("Specific Settings")] [Tooltip("Replace characters for bad words (default: *).")]
        ...
        [Header("Bad Word Providers")] [Tooltip("List of all left-to-right providers.")]
        ...
        public void OnEnable()
        {
            ...
            else if (!BaseHelper.isEditorMode && DontDestroy && instance != this)
            {
                if (!loggedOnlyOneInstance)
                {
                    ...
                    Debug.LogWarning("Only one active instance of 'BadWordManager' allowed in all scenes!" + Environment.NewLine +
        ...
        public static void Load()
        {
            if (instance != null)
            {
                filter = new BadWordFilter(instance.BadWordProviderLTR, instance.BadWordProviderRTL, instance.ReplaceChars, instance.ReplaceLeetSpeak,
                    instance.SimpleCheck);
            }
        }
