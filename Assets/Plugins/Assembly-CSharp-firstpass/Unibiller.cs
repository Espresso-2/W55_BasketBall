...
*//*	public static BillingPlatform BillingPlatform
	...
	//		{
	//			action2 = action;
	//			action = Interlocked.CompareExchange(ref Unibiller.onPurchaseComplete, (Action<PurchaseEvent>)Delegate.Combine(action2, value), action);
	//		}
	...
	//		{
	//			action2 = action;
	//			action = Interlocked.CompareExchange(ref Unibiller.onPurchaseComplete, (Action<PurchaseEvent>)Delegate.Remove(action2, value), action);
	//		}
	//		while ((object)action != action2);
	//	}
	//}
