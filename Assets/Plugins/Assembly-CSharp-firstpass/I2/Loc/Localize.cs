...
namespace I2.Loc
{
	...
	public class Localize : MonoBehaviour
	{
		...
		public void OnLocalize(bool Force = false)
		{
			...
			MainTranslation = ((!string.IsNullOrEmpty(FinalTerm) && !(FinalTerm == "-")) ? LocalizationManager.GetTermTranslation(FinalTerm, false) : null);
			SecondaryTranslation = ((!string.IsNullOrEmpty(FinalSecondaryTerm) && !(FinalSecondaryTerm == "-")) ? LocalizationManager.GetTermTranslation(FinalSecondaryTerm, false) : null);
		...
		{
			SetFinalTerms((!mTarget_uGUI_Image.mainTexture) ? string.Empty : mTarget_uGUI_Image.mainTexture.name, null, out primaryTerm, out secondaryTerm, false);
		}
		...
		{
			SetFinalTerms((!mTarget_uGUI_RawImage.texture) ? string.Empty : mTarget_uGUI_RawImage.texture.name, null, out primaryTerm, out secondaryTerm, false);
		}
		...
		{
			SetFinalTerms((!(mTarget_SpriteRenderer.sprite != null)) ? string.Empty : mTarget_SpriteRenderer.sprite.name, string.Empty, out PrimaryTerm, out secondaryTranslation, false);
		}
