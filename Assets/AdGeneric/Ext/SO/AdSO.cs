...
namespace AdGeneric.SO
{
    [CreateAssetMenu(fileName = "AdSO", menuName = "SO/AdSO", order = 0)]
    public class AdSO : ScriptableObject
    {
        [SerializeField] private Sprite twelve;
        [SerializeField] private Sprite sixteen;
        [SerializeField,TextArea(5,10)] private string healthText;
        [SerializeField,TextArea(20,800)] private string privacyText;
        ...
        public Sprite Twelve => twelve;

        public Sprite Sixteen => sixteen;
        
        
        public const string PhoneFormat = "联系电话：{0}";
        public const string EmailFormat = "客服邮箱：{0}";
        public const string PrimaryFormat = @"
隐私政策
更新日期：2023年8月25日
...
欢迎您选择由{0}（以下简称“我们”）提供的游戏或应用APP产品（以下统称“APP”）。建议您完整地阅读本隐私政策，以帮助您了解维护自己隐私权的方式。如您对本隐私政策有任何疑问，您可以通过平台公布的联系方式与我们联系。我们重视未成年人的个人信息保护，如您为未成年人，建议您请您的监护人仔细阅读本隐私政策,并在征得您的监护人 同意的前提下使用我们的服务或向我们提供信息。本隐私政策主要从以下几个方面帮您详细了解我们或我们合作的第三方如何收集、使用、存储、传输、共享与保护个人信息；帮您了解查询、访问、删除、更正、撤回授权个人信息的方式。
