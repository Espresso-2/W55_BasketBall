...
{
    [Operation(global::AdGeneric.Operation.Operation.陈志晴)]
    public class ChenZhiQing:BaseOperation
    {
        #region value
        ...
        {
            if (AdTotalManager.Instance.Operation != global::AdGeneric.Operation.Operation.陈志晴) return;
            print(nameof(ChenZhiQing));
#if !UNITY_EDITOR
