...
{
    [Operation(global::AdGeneric.Operation.Operation.万世荣)]
    public class WanShiRong:BaseOperation
    {
        #region value
        ...
        {
            if (AdTotalManager.Instance.Operation != global::AdGeneric.Operation.Operation.万世荣) return;
            print(nameof(WanShiRong));
#if !UNITY_EDITOR
