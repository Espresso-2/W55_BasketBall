...
{
    [Operation(global::AdGeneric.Operation.Operation.标越)]
    public class BiaoYue:BaseOperation
    {
        #region value
        ...
        {
            if (AdTotalManager.Instance.Operation != global::AdGeneric.Operation.Operation.标越) return;
            print(nameof(BiaoYue));
#if !UNITY_EDITOR
