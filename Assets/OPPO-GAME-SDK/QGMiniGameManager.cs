...
namespace QGMiniGame
{
    public class QGMiniGameManager : MonoBehaviour
    {
        ...
        public QGCustomAd CreateCustomAdZone(QGCreateCustomAdParam param)
        {
            var adId = QGCallBackManager.getKey();
            QGCustomAd ad = new QGCustomAd(adId);
            QGCreateCustomAdZone(adId, param.adUnitId, JsonUtility.ToJson(param.style));
            return ad;
        }
        ...
        public void Pay(PayParam param, Action<QGCommonResponse<QGPayBean>> successCallback = null, Action<QGCommonResponse<QGPayBean>> failCallback = null,
            Action<QGCommonResponse<QGPayBean>> completeCallback = null)
        {
        ...
        public void OutPutLog(string content, int logType)
        {
            int l = (int)logType;
            JsLog(content, l.ToString());
        }
        ...
        {
            string timeStr = GetWebCurrentTime();
        ...
        public void Record(int duration, int sampleRate, int numberOfChannels, int encodeBitRate)
        {
            QGRecord(duration, sampleRate, numberOfChannels, encodeBitRate);
        }
        ...
        [DllImport("__Internal")]
        private static extern void QGCreateShortcutButton();
        ...
        [DllImport("__Internal")]
        public static extern void QGQuitGame();

        [DllImport("__Internal")]
        public static extern void QGShowToast(string content);

        [DllImport("__Internal")]
        public static extern void JsLog(string content, string logType);

        [DllImport("__Internal")]
        public static extern string GetWebCurrentTime();

        [DllImport("__Internal")]
        private static extern void QGCreateCustomAdZone(string a, string p, string s);

        [DllImport("__Internal")]
        public static extern void QGRecord(int d, int s, int n, int e);

        [DllImport("__Internal")]
        public static extern void QGPlayRecord();
    }
}